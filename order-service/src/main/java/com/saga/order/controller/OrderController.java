...
@Tag(
        ...
        description = "APIs for managing pizza orders and orchestrating the distributed saga workflow"
)
public class OrderController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "201",
                    description = "Order created successfully and saga initiated",
                    content = @Content(
    ...
    public ResponseEntity<Order> createOrder(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Order details including customer ID, pizza type, quantity, and delivery address",
                    required = true,
                    content = @Content(
                            mediaType = "application/json",
                            ...
                            examples = {
                                    ...
                                    @ExampleObject(
                                            name = "Multiple Pepperoni Pizzas",
                                            value = """
                                    {
                                      "customerId": "CUST002",
                                      "pizzaType": "Pepperoni",
                    ...
                    content = @Content(
                            ...
                            examples = {
                                ...
                                """
                                    ...
                                    @ExampleObject(
                                            name = "Cancelled Order (After Compensation)",
                                            value = """
                                {
